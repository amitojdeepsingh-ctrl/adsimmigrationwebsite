exports.id=911,exports.ids=[911],exports.modules={6216:(e,o,a)=>{Promise.resolve().then(a.t.bind(a,4536,23))},7157:(e,o,a)=>{"use strict";a.d(o,{A5:()=>t,WT:()=>r,fv:()=>i});let t=[{slug:"express-entry-crs-score-2024",title:"How to Improve Your Express Entry CRS Score in 2024",description:"Your CRS score determines whether you get invited to apply for Canadian permanent residency. Here's exactly how to improve it.",date:"2024-10-15",category:"Express Entry",readTime:"8 min read",content:`
...
If you're not sure where to start, book a free CRS assessment. We'll calculate your current score, identify your best improvement opportunities, and create a personalized timeline.
    `.trim()},{slug:"study-permit-to-pr-complete-guide",title:"Study Permit to Permanent Residency: The Complete Guide (2024)",description:"International students have one of the clearest paths to Canadian PR. Here's exactly how it works — step by step.",date:"2024-09-28",category:"Study Permits",readTime:"10 min read",content:`
...
If you're an international student or planning to study in Canada, book a free consultation. We'll review your program, calculate your PR timeline, and make sure you don't make any costly mistakes.
    `.trim()},{slug:"sowp-spousal-open-work-permit-guide",title:"Spousal Open Work Permit (SOWP): Complete Guide for 2024",description:"How the SOWP works, who qualifies, and how couples can use it to build Canadian income and PR pathways simultaneously.",date:"2024-09-10",category:"Work Permits",readTime:"7 min read",content:`
...
Book a free consultation with us. We'll map out a dual application strategy that maximizes your chances of approval, minimizes your waiting time, and sets both of you up for the fastest possible path to PR.
    `.trim()},{slug:"pnp-provincial-nominee-program-guide",title:"Provincial Nominee Program (PNP): Which Province Is Right for You?",description:"PNP adds 600 CRS points to your Express Entry profile. But with 85+ streams across Canada, how do you know which province to target?",date:"2024-08-22",category:"PNP",readTime:"9 min read",content:`
...
Book a free PNP assessment. We'll analyze your profile, identify your best provincial matches, and create a strategy to get you nominated as quickly as possible.
    `.trim()}];function i(e){return t.find(o=>o.slug===e)}function r(){return t.map(e=>e.slug)}},9768:(e,o,a)=>{Promise.resolve().then(a.t.bind(a,5814,23))}};